...
app.get('/', (req, res) => {
  res.send(h('html', { lang: 'en'} ,
    h('head', { prefix: 'og: http://ogp.me/ns#' },
      ...
      h('meta', { name: 'description', content: 'Lightning Talk Timer' }),
      h('meta', { name: 'twitter:card', content: 'summary_large_image' }),
      h('meta', { name: 'twitter:title', content: 'Lightning Talk Timer' }),
      h('meta', { name: 'twitter:image', content: 'https://lightning-talk-remote-timer.herokuapp.com/20210307044226_demo.jpg' }),
      h('link', {
        rel: 'stylesheet',
        ...
        h('.container',
          h('.card.my-3',
            ...
            h('.card-body',
              ...
              h('p.card-text', 'タイマーの操作が同じタイマーを見ているほかのユーザーにも同期します。司会者がタイマーを操作することで、発表者や視聴者は手元で残り時間を把握しやすくなります。')))),
        ...
        h('.container',
          h('.card.my-3',
            ...
            h('.card-body',
              ...
              h('p.card-text', 'どの大きさのディスプレイでも文字盤が画面いっぱいに表示されます。')))),
        ...
        h('.container', 
          h('.card.my-3', 
            ...
            h('.card-body', 
              ...
              h('p.card-text', 'タイマーの動作している間、画面に見えないところでごく軽量の動画を再生することでスクリーンセーバーやオートスリープを防ぎます。タイマーが表示されなくなる、操作できなくなる、などのトラブルを防ぎます。')))),
